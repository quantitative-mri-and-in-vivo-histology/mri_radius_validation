...
r_eff_mri_mean_values_smoothed = r_eff_mri_mean_values(valid_idx);
r_eff_histo_mean_values_smoothed = r_eff_histo_mean_values(valid_idx);

valid_idx = sum(~isnan(r_eff_mri_values_per_sub_unsmoothed),2)>=3;
r_eff_mri_mean_values = ...
    mean(r_eff_mri_values_per_sub_unsmoothed, 2, 'omitnan');
r_eff_histo_mean_values = r_eff_reference_in_vivo';
r_eff_mri_mean_values_unsmoothed = r_eff_mri_mean_values(valid_idx);
r_eff_histo_mean_values_unsmoothed = r_eff_histo_mean_values(valid_idx);
...
plot_r_eff_correlation_ensemble(ax, ...
    r_eff_histo_mean_values_unsmoothed', ...
...
rand_stream = RandStream(sim_params.random_generator, ...
    'Seed', sim_params.random_seed);
plot_r_eff_correlation_ensemble(ax, ...
    r_eff_histo_mean_values_smoothed', ...
