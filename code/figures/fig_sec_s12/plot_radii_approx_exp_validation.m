...
plot_r_eff_correlation_ensemble(ax_experiments, ...
    ...
    'ylim', lims, ...
    'rand_stream', rand_stream);
xlabel("$r_{\mathrm{eff}}$ [$\mu$m] (histology)" + newline + "(circular equivalent)", ...
    'Interpreter', 'latex');
...
plot_r_eff_correlation_ensemble(ax_experiments, ...
    ...
    'ylim', lims, ...
    'rand_stream', rand_stream);
xlabel("$r_{\mathrm{eff}}$ [$\mu$m] (histology)" + newline + "(ellipse minor axis)", ...
    'Interpreter', 'latex');
ylabel("$r_{\mathrm{eff}}$ [$\mu$m] (dMRI)", ...
    'Interpreter', 'latex');
lgd = legend('Interpreter', 'latex', ...
...
plot_r_eff_correlation_ensemble(ax_experiments, ...
    ...
    'ylim', lims, ...
    'rand_stream', rand_stream);
xlabel("$r_{\mathrm{eff}}$ [$\mu$m] (histology)" + newline + "(ellipse major axis)", ...
    'Interpreter', 'latex');
ylabel("$r_{\mathrm{eff}}$ [$\mu$m] (dMRI)", ...
    'Interpreter', 'latex');
lgd = legend('Interpreter', 'latex', ...
