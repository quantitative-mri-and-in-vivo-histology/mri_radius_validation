...
% get histograms with ex-vivo tissue scaling
[r_roi_counts_in_vivo_circ_eq, r_effs_reference_in_vivo_circ_eq] = get_histology_data(...
    fullfile(getenv("MRV_DATA_PATH")),...
    sim_params.r_bin_edges,...
    "circular_equivalent",...
    "scaling_factor", tissue_params_in_vivo.histology_scaling_factor);
...
% get histograms with ex-vivo tissue scaling
[r_roi_counts_in_vivo_minor_axis, r_effs_reference_in_vivo_minor_axis] = get_histology_data(...
    fullfile(getenv("MRV_DATA_PATH")),...
    sim_params.r_bin_edges,...
    "minor_axis",...
    "scaling_factor", tissue_params_in_vivo.histology_scaling_factor);
...
% get histograms with ex-vivo tissue scaling
[r_roi_counts_in_vivo_major_axis, r_effs_reference_in_vivo_major_axis] = get_histology_data(...
    fullfile(getenv("MRV_DATA_PATH")),...
    sim_params.r_bin_edges,...
    "major_axis",...
    "scaling_factor", tissue_params_in_vivo.histology_scaling_factor);
...
% r_eff_histo_mean_values_circ_eq = r_effs_reference_in_vivo_circ_eq';
% r_eff_histo_mean_values_minor_axis = r_effs_reference_in_vivo_minor_axis';
% r_eff_histo_mean_values_major_axis = r_effs_reference_in_vivo_major_axis';
...
plot_r_eff_correlation_ensemble(ax_experiments, ...
    r_effs_reference_ex_vivo_circ_eq(ex_vivo_table.unique_id), ...
...
rand_stream = RandStream(sim_params.random_generator, ...
    'Seed', sim_params.random_seed);
plot_r_eff_correlation_ensemble(ax_experiments, ...
    r_effs_reference_in_vivo_circ_eq, ...
...
rand_stream = RandStream(sim_params.random_generator, ...
    'Seed', sim_params.random_seed);
plot_r_eff_correlation_ensemble(ax_experiments, ...
    r_effs_reference_ex_vivo_minor_axis(ex_vivo_table.unique_id), ...
    ex_vivo_table.r_eff_mri_median, ...
    'color', color_ex_vivo, ...
    'legend_prefix', legend_prefix_ex_vivo, ...
    'xlim', lims, ...
...
rand_stream = RandStream(sim_params.random_generator, ...
    'Seed', sim_params.random_seed);
plot_r_eff_correlation_ensemble(ax_experiments, ...
    r_effs_reference_in_vivo_minor_axis, ...
    r_eff_mri_mean_values, ...
    'color', color_in_vivo, ...
    'legend_prefix', legend_prefix_in_vivo, ...
    'xlim', lims, ...
...
rand_stream = RandStream(sim_params.random_generator, ...
    'Seed', sim_params.random_seed);
plot_r_eff_correlation_ensemble(ax_experiments, ...
    r_effs_reference_ex_vivo_major_axis(ex_vivo_table.unique_id), ...
    ex_vivo_table.r_eff_mri_median, ...
    'color', color_ex_vivo, ...
    'legend_prefix', legend_prefix_ex_vivo, ...
    'xlim', lims, ...
...
rand_stream = RandStream(sim_params.random_generator, ...
    'Seed', sim_params.random_seed);
plot_r_eff_correlation_ensemble(ax_experiments, ...
    r_effs_reference_in_vivo_major_axis, ...
    r_eff_mri_mean_values, ...
    'color', color_in_vivo, ...
    'legend_prefix', legend_prefix_in_vivo, ...
    'xlim', lims, ...
...
% save figure
print(gcf, '-dsvg', "quantitative_comparison_radii_approximations.svg");