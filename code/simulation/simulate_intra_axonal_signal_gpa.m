function s = simulate_intra_axonal_signal_gpa(r, fiber_dir, bvec, bval, small_delta, big_delta, d_0, d_a_par)
% Simulates intra-axonal dMRI signal using GPA.
%
%   Simulates the intra-axonal diffusion-weighted MRI signal using the 
%   Gaussian Phase Approximation (GPA), incorporating both parallel and 
%   perpendicular diffusion components.
%
% USAGE:
%   s = simulate_intra_axonal_signal_gpa(r, fiber_dir, bvec, bval, ...
...
xi = (bvec * fiber_dir');
s_perp = simulate_cylinder_signal_gpa(r, fiber_dir, bvec, bval, small_delta, big_delta, d_0);
