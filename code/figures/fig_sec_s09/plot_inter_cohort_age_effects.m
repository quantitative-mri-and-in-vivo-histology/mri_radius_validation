% ========================================================================
% Assess effect of inter-cohort age differences on effective radius 
...
young_adults_scaling_factor = ...
    opt.tissue_params.histology_scaling_factor*0.947; % based on Fan et al. 2019 (see Fig. 4a, https://doi.org/10.1016/j.neuroimage.2019.02.036)
[r_roi_counts, ...
    ~] = get_histology_data(...
    fullfile(getenv("MRV_DATA_PATH")),...
    opt.sim_params.r_bin_edges,...
    opt.sim_params.radius_approximation,...
    "scaling_factor", young_adults_scaling_factor);
...
% save figure
print(gcf, '-dsvg', "inter_cohort_age_effects.svg");
